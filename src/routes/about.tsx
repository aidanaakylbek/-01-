...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About - AulBridge" },
      {
        name: "description",
        content: "About AulBridge and its mission for rural students.",
      },
    ],
  }),
  component: About,
...
function About() {
  ...
  const copy =
    language === "KZ"
      ? {
          title: "Біз туралы",
          body: "AulBridge ауыл оқушыларына НИШ, БИЛ және РФМШ-ға дайындалуға көмектеседі: диагностика, жеке оқу жоспары және ата-аналарға түсінікті есептер арқылы.",
          cards: [
      ...
      : language === "RU"
        ? {
            title: "О нас",
            body: "AulBridge помогает ученикам из сельских регионов готовиться к НИШ, БИЛ и РФМШ через диагностику, персональный учебный план и понятные отчеты для родителей.",
            cards: [
        ...
        : {
            title: "About",
            body: "AulBridge helps rural students prepare for NIS, BIL, and NSPM through diagnostics, a personalized study plan, and clear parent reports.",
            cards: [
