...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "About Bridge and its mission for exam preparation.",
      },
    ],
  }),
  component: About,
...
function About() {
  ...
  const copy =
    language === "KZ"
      ? {
          title: "Біз туралы",
          body: "Bridge НИШ, БИЛ және РФМШ-ға дайындалатын әр оқушыға көмектеседі: диагностика, жеке оқу жоспары және ата-аналарға түсінікті есептер арқылы.",
          cards: [
      ...
      : language === "RU"
        ? {
            title: "О нас",
            body: "Bridge помогает каждому ученику готовиться к НИШ, БИЛ и РФМШ через диагностику, персональный учебный план и понятные отчеты для родителей.",
            cards: [
        ...
        : {
            title: "About",
            body: "Bridge helps every student prepare for NIS, BIL, and NSPM through diagnostics, a personalized study plan, and clear parent reports.",
            cards: [
